    ...
    <div className="p-4">
      ...
      <div className="mb-4 rounded-lg bg-white p-4">
        ...
        <textarea
          ...
          maxLength={1000}
          placeholder="今天心情怎么样？"
          className="mb-2 w-full resize-none rounded-lg border border-neutral-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-amber-300"
        />
        <p className="mb-2 text-xs text-neutral-400">{content.length}/1000</p>
      ...
      {loading ? (
        ...
        <p className="text-sm text-neutral-400">还没有历史日记</p>
      ) : (
          ...
          {diaries.map((d) => {
            ...
            return (
              <div key={d.id} className="rounded-lg bg-white p-3">
                ...
                <p className="text-sm text-neutral-600">{d.content}</p>
                {d.is_private && (
                  <p className="mt-1 text-xs text-neutral-400">私密</p>
                )}
              </div>
            );
          })}
